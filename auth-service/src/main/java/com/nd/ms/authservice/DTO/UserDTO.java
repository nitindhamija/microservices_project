package com.nd.ms.authservice.DTO;
...
@JsonPropertyOrder({"id", "created", "firstName", "lastName", "email", "userName", "password", "enabled", "roles"})
public class UserDTO {
  ...
  public boolean equals(Object other) {
    if (other == this)
      return true; 
    if (!(other instanceof com.nd.ms.authservice.DTO.UserDTO))
      return false; 
    com.nd.ms.authservice.DTO.UserDTO rhs = (com.nd.ms.authservice.DTO.UserDTO)other;
